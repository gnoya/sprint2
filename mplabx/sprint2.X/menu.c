...
void index_add(void) {
    ...
    if(menu_current == 0 && menu_index >4) menu_index = 4; // Main Menu
    if(menu_current == 1 && menu_index >4) menu_index = 4; // Operating Mode Menu
    if(menu_current == 2 && menu_index >3) menu_index = 3; // Select Sensor Menu
    show = 1;
